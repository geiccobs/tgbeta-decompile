...
import j$.util.stream.AbstractC0140o1;
...
public abstract /* synthetic */ class AbstractC0039a {
    ...
    public static Comparator H(Comparator comparator, Comparator comparator2) {
        if (comparator instanceof AbstractC0043e) {
            return ((EnumC0044f) ((AbstractC0043e) comparator)).thenComparing(comparator2);
        }
        comparator2.getClass();
        return new C0041c(comparator, comparator2);
    }
    ...
    public static Stream g(Collection collection) {
        return AbstractC0140o1.y(Collection$EL.b(collection), true);
    }
    ...
    public static Stream i(Collection collection) {
        return AbstractC0140o1.y(Collection$EL.b(collection), false);
    }
    ...
    public static boolean j(t tVar, Consumer consumer) {
        ...
        if (!N.a) {
            consumer.getClass();
            return tVar.k(new C0052m(consumer));
        }
    ...
    public static C0049j q(OptionalDouble optionalDouble) {
        if (optionalDouble == null) {
            return null;
        }
        return optionalDouble.isPresent() ? C0049j.d(optionalDouble.getAsDouble()) : C0049j.a();
    }

    public static C0050k r(OptionalInt optionalInt) {
        if (optionalInt == null) {
            return null;
        }
        return optionalInt.isPresent() ? C0050k.d(optionalInt.getAsInt()) : C0050k.a();
    }

    public static C0051l s(OptionalLong optionalLong) {
        if (optionalLong == null) {
            return null;
        }
        return optionalLong.isPresent() ? C0051l.d(optionalLong.getAsLong()) : C0051l.a();
    }
    ...
    public static OptionalDouble u(C0049j c0049j) {
        if (c0049j == null) {
            return null;
        }
        return c0049j.c() ? OptionalDouble.of(c0049j.b()) : OptionalDouble.empty();
    }

    public static OptionalInt v(C0050k c0050k) {
        if (c0050k == null) {
            return null;
        }
        return c0050k.c() ? OptionalInt.of(c0050k.b()) : OptionalInt.empty();
    }

    public static OptionalLong w(C0051l c0051l) {
        if (c0051l == null) {
            return null;
        }
        return c0051l.c() ? OptionalLong.of(c0051l.b()) : OptionalLong.empty();
    }
