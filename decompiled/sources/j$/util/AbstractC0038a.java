...
import j$.util.stream.AbstractC0139o1;
...
public abstract /* synthetic */ class AbstractC0038a {
    ...
    public static Comparator H(Comparator comparator, Comparator comparator2) {
        if (comparator instanceof AbstractC0042e) {
            return ((EnumC0043f) ((AbstractC0042e) comparator)).thenComparing(comparator2);
        }
        comparator2.getClass();
        return new C0040c(comparator, comparator2);
    }
    ...
    public static Stream g(Collection collection) {
        return AbstractC0139o1.y(Collection$EL.b(collection), true);
    }
    ...
    public static Stream i(Collection collection) {
        return AbstractC0139o1.y(Collection$EL.b(collection), false);
    }
    ...
    public static boolean j(t tVar, Consumer consumer) {
        ...
        if (!N.a) {
            consumer.getClass();
            return tVar.k(new C0051m(consumer));
        }
    ...
    public static C0048j q(OptionalDouble optionalDouble) {
        if (optionalDouble == null) {
            return null;
        }
        return optionalDouble.isPresent() ? C0048j.d(optionalDouble.getAsDouble()) : C0048j.a();
    }

    public static C0049k r(OptionalInt optionalInt) {
        if (optionalInt == null) {
            return null;
        }
        return optionalInt.isPresent() ? C0049k.d(optionalInt.getAsInt()) : C0049k.a();
    }

    public static C0050l s(OptionalLong optionalLong) {
        if (optionalLong == null) {
            return null;
        }
        return optionalLong.isPresent() ? C0050l.d(optionalLong.getAsLong()) : C0050l.a();
    }
    ...
    public static OptionalDouble u(C0048j c0048j) {
        if (c0048j == null) {
            return null;
        }
        return c0048j.c() ? OptionalDouble.of(c0048j.b()) : OptionalDouble.empty();
    }

    public static OptionalInt v(C0049k c0049k) {
        if (c0049k == null) {
            return null;
        }
        return c0049k.c() ? OptionalInt.of(c0049k.b()) : OptionalInt.empty();
    }

    public static OptionalLong w(C0050l c0050l) {
        if (c0050l == null) {
            return null;
        }
        return c0050l.c() ? OptionalLong.of(c0050l.b()) : OptionalLong.empty();
    }
