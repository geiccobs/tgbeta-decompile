...
public enum EnumC0039f implements Comparator, AbstractC0038e {
    INSTANCE;
    ...
    public Comparator thenComparing(Comparator comparator) {
        comparator.getClass();
        return new C0036c(this, comparator);
    }
    ...
    public Comparator thenComparingDouble(ToDoubleFunction toDoubleFunction) {
        ...
        a2.getClass();
        return AbstractC0034a.H(this, new C0037d(a2));
    }

    @Override // java.util.Comparator
    public Comparator thenComparingInt(ToIntFunction toIntFunction) {
        return AbstractC0034a.H(this, Comparator$CC.comparingInt(D0.a(toIntFunction)));
    }
    ...
    public Comparator thenComparing(Function function) {
        return AbstractC0034a.H(this, Comparator$CC.comparing(j$.wrappers.M.a(function)));
    }
    ...
    public Comparator thenComparing(Function function, Comparator comparator) {
        ...
        a2.getClass();
        comparator.getClass();
        return AbstractC0034a.H(this, new C0036c(comparator, a2));
    }
}
