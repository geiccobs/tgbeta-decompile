...
public enum EnumC0044f implements Comparator, AbstractC0043e {
    INSTANCE;
    ...
    public Comparator thenComparing(Comparator comparator) {
        comparator.getClass();
        return new C0041c(this, comparator);
    }
    ...
    public Comparator thenComparingDouble(ToDoubleFunction toDoubleFunction) {
        ...
        a2.getClass();
        return AbstractC0039a.H(this, new C0042d(a2));
    }

    @Override // java.util.Comparator
    public Comparator thenComparingInt(ToIntFunction toIntFunction) {
        return AbstractC0039a.H(this, Comparator$CC.comparingInt(D0.a(toIntFunction)));
    }
    ...
    public Comparator thenComparing(Function function) {
        return AbstractC0039a.H(this, Comparator$CC.comparing(j$.wrappers.M.a(function)));
    }
    ...
    public Comparator thenComparing(Function function, Comparator comparator) {
        ...
        a2.getClass();
        comparator.getClass();
        return AbstractC0039a.H(this, new C0041c(comparator, a2));
    }
}
