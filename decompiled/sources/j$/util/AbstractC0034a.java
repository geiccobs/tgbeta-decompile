...
public abstract /* synthetic */ class AbstractC0034a {
    ...
    public static Comparator H(Comparator comparator, Comparator comparator2) {
        if (comparator instanceof AbstractC0038e) {
            return ((EnumC0039f) ((AbstractC0038e) comparator)).thenComparing(comparator2);
        }
        comparator2.getClass();
        return new C0036c(comparator, comparator2);
    }
    ...
    public static Stream g(Collection collection) {
        return AbstractC0135o1.y(Collection$EL.b(collection), true);
    }
    ...
    public static Stream i(Collection collection) {
        return AbstractC0135o1.y(Collection$EL.b(collection), false);
    }
    ...
    public static boolean j(t tVar, Consumer consumer) {
        ...
        if (!N.a) {
            consumer.getClass();
            return tVar.k(new C0047m(consumer));
        }
    ...
    public static C0044j q(OptionalDouble optionalDouble) {
    ...
    public static C0045k r(OptionalInt optionalInt) {
        if (optionalInt == null) {
            return null;
        }
    ...
    public static C0046l s(OptionalLong optionalLong) {
    ...
    public static OptionalDouble u(C0044j c0044j) {
        if (c0044j == null) {
            return null;
        }
    ...
    public static OptionalInt v(C0045k c0045k) {
        if (c0045k == null) {
            return null;
        }
    ...
    public static OptionalLong w(C0046l c0046l) {
        if (c0046l == null) {
            return null;
        }
