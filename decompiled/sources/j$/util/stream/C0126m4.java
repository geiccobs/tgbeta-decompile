...
final class C0126m4 implements j$.util.u, Consumer {
    private static final Object d = new Object();
    private final j$.util.u a;
    private final ConcurrentHashMap b;
    private Object c;

    public C0126m4(j$.util.u uVar) {
        ConcurrentHashMap concurrentHashMap = new ConcurrentHashMap();
        this.a = uVar;
        this.b = concurrentHashMap;
    }

    private C0126m4(j$.util.u uVar, ConcurrentHashMap concurrentHashMap) {
        this.a = uVar;
        this.b = concurrentHashMap;
    }
    ...
    public void forEachRemaining(Consumer consumer) {
        this.a.forEachRemaining(new C0133o(this, consumer));
    }
    ...
    public j$.util.u trySplit() {
        ...
        if (trySplit != null) {
            return new C0126m4(trySplit, this.b);
        }
        return null;
    }
}
