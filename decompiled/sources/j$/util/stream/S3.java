...
public class S3 implements j$.util.u {
    ...
    final int d;
    Object[] e;
    final /* synthetic */ C0053a4 f;

    public S3(C0053a4 c0053a4, int i, int i2, int i3, int i4) {
        this.f = c0053a4;
        this.a = i;
        this.b = i2;
        this.c = i3;
        ...
        this.e = objArr == null ? c0053a4.e : objArr[i];
    }
    ...
    public j$.util.u trySplit() {
        ...
        int i2 = this.b;
        if (i < i2) {
            C0053a4 c0053a4 = this.f;
            int i3 = i2 - 1;
            S3 s3 = new S3(c0053a4, i, i3, this.c, c0053a4.f[i3].length);
            int i4 = this.b;
            this.a = i4;
            this.c = 0;
            this.e = this.f.f[i4];
