...
public final class C0150q4 extends AbstractC0084f4 implements u.a {
    public C0150q4(AbstractC0188y2 abstractC0188y2, j$.util.function.y yVar, boolean z) {
        super(abstractC0188y2, yVar, z);
    }

    C0150q4(AbstractC0188y2 abstractC0188y2, j$.util.u uVar, boolean z) {
    ...
    public void forEachRemaining(j$.util.function.l lVar) {
        ...
        lVar.getClass();
        h();
        this.b.u0(new C0144p4(lVar), this.d);
        this.i = true;
    }
    ...
    void j() {
        W3 w3 = new W3();
        this.h = w3;
        this.e = this.b.v0(new C0144p4(w3));
        this.f = new C0055b(this);
    }

    @Override // j$.util.stream.AbstractC0084f4
    AbstractC0084f4 l(j$.util.u uVar) {
        return new C0150q4(this.b, uVar, this.a);
    }
