...
public abstract /* synthetic */ class AbstractC0033a {
    ...
    public static Comparator H(Comparator comparator, Comparator comparator2) {
        if (comparator instanceof AbstractC0037e) {
            return ((EnumC0038f) ((AbstractC0037e) comparator)).thenComparing(comparator2);
        }
        comparator2.getClass();
        return new C0035c(comparator, comparator2);
    }
    ...
    public static Stream g(Collection collection) {
        return AbstractC0134o1.y(Collection$EL.b(collection), true);
    }
    ...
    public static Stream i(Collection collection) {
        return AbstractC0134o1.y(Collection$EL.b(collection), false);
    }
    ...
    public static boolean j(t tVar, Consumer consumer) {
        ...
        if (!N.a) {
            consumer.getClass();
            return tVar.k(new C0046m(consumer));
        }
    ...
    public static C0043j q(OptionalDouble optionalDouble) {
        if (optionalDouble == null) {
            return null;
        }
        return optionalDouble.isPresent() ? C0043j.d(optionalDouble.getAsDouble()) : C0043j.a();
    }

    public static C0044k r(OptionalInt optionalInt) {
        if (optionalInt == null) {
            return null;
        }
        return optionalInt.isPresent() ? C0044k.d(optionalInt.getAsInt()) : C0044k.a();
    }

    public static C0045l s(OptionalLong optionalLong) {
        if (optionalLong == null) {
            return null;
        }
        return optionalLong.isPresent() ? C0045l.d(optionalLong.getAsLong()) : C0045l.a();
    }
    ...
    public static OptionalDouble u(C0043j c0043j) {
        if (c0043j == null) {
            return null;
        }
        return c0043j.c() ? OptionalDouble.of(c0043j.b()) : OptionalDouble.empty();
    }

    public static OptionalInt v(C0044k c0044k) {
        if (c0044k == null) {
            return null;
        }
        return c0044k.c() ? OptionalInt.of(c0044k.b()) : OptionalInt.empty();
    }

    public static OptionalLong w(C0045l c0045l) {
        if (c0045l == null) {
            return null;
        }
        return c0045l.c() ? OptionalLong.of(c0045l.b()) : OptionalLong.empty();
    }
