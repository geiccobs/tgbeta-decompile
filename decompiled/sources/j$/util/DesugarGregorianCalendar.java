...
public class DesugarGregorianCalendar {
    ...
    public static GregorianCalendar from(ZonedDateTime zdt) {
        ...
        try {
            cal.setTimeInMillis(Clock$OffsetClock$$ExternalSyntheticBackport0.m(Duration$$ExternalSyntheticBackport1.m(zdt.toEpochSecond(), 1000L), zdt.get(ChronoField.MILLI_OF_SECOND)));
            return cal;
