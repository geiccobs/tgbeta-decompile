...
class A implements AbstractC0047n, j$.util.function.f, Iterator {
    boolean a = false;
    double b;
    final /* synthetic */ t c;
    ...
    public void forEachRemaining(Consumer consumer) {
        ...
        consumer.getClass();
        if (!N.a) {
            forEachRemaining(new C0046m(consumer));
        } else {
    ...
    @Override // j$.util.AbstractC0047n, java.util.Iterator, j$.util.Iterator
    public Double next() {
        if (!N.a) {
