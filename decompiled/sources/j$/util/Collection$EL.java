...
public final /* synthetic */ class Collection$EL {
    public static /* synthetic */ void a(Collection collection, Consumer consumer) {
        if (collection instanceof AbstractC0034b) {
            ((AbstractC0034b) collection).forEach(consumer);
        } else {
            AbstractC0033a.a(collection, consumer);
        }
    }
    ...
    public static /* synthetic */ boolean removeIf(Collection collection, Predicate predicate) {
        return collection instanceof AbstractC0034b ? ((AbstractC0034b) collection).k(predicate) : AbstractC0033a.h(collection, predicate);
    }
}
