...
public final /* synthetic */ class C$r8$wrapper$java$util$stream$Stream$VWRP implements Stream {
    ...
    public /* synthetic */ Object B(Object obj, BiFunction biFunction, j$.util.function.b bVar) {
        return this.a.reduce(obj, C0228t.a(biFunction), C0230v.a(bVar));
    }
    ...
    public /* synthetic */ Stream V(Consumer consumer) {
        return convert(this.a.peek(C0232x.a(consumer)));
    }
    ...
    @Override // j$.util.stream.Stream
    public /* synthetic */ AbstractC0074e1 X(Function function) {
    ...
    @Override // j$.util.stream.Stream, j$.util.stream.AbstractC0084g, java.lang.AutoCloseable
    ...
    public /* synthetic */ void e(Consumer consumer) {
        this.a.forEachOrdered(C0232x.a(consumer));
    }

    @Override // j$.util.stream.Stream
    public /* synthetic */ Optional findAny() {
        return AbstractC0033a.p(this.a.findAny());
    }

    @Override // j$.util.stream.Stream
    public /* synthetic */ Optional findFirst() {
        return AbstractC0033a.p(this.a.findFirst());
    }

    @Override // j$.util.stream.Stream
    public /* synthetic */ void forEach(Consumer consumer) {
        this.a.forEach(C0232x.a(consumer));
    }

    @Override // j$.util.stream.Stream
    public /* synthetic */ AbstractC0074e1 g0(j$.util.function.A a) {
    ...
    public /* synthetic */ Object m0(Object obj, j$.util.function.b bVar) {
        return this.a.reduce(obj, C0230v.a(bVar));
    }

    @Override // j$.util.stream.Stream
    public /* synthetic */ Optional max(Comparator comparator) {
        return AbstractC0033a.p(this.a.max(comparator));
    }

    @Override // j$.util.stream.Stream
    public /* synthetic */ Optional min(Comparator comparator) {
        return AbstractC0033a.p(this.a.min(comparator));
    }
    ...
    public /* synthetic */ Optional t(j$.util.function.b bVar) {
        return AbstractC0033a.p(this.a.reduce(C0230v.a(bVar)));
    }
