...
public final /* synthetic */ class M0 implements DoubleStream {
    ...
    public /* synthetic */ Object collect(Supplier supplier, ObjDoubleConsumer objDoubleConsumer, BiConsumer biConsumer) {
        return this.a.H(z0.a(supplier), r0.a(objDoubleConsumer), C0226q.a(biConsumer));
    }
    ...
    public /* synthetic */ OptionalDouble findAny() {
        return AbstractC0033a.u(this.a.findAny());
    }

    @Override // java.util.stream.DoubleStream
    public /* synthetic */ OptionalDouble findFirst() {
        return AbstractC0033a.u(this.a.findFirst());
    }
    ...
    public /* synthetic */ OptionalDouble max() {
        return AbstractC0033a.u(this.a.max());
    }

    @Override // java.util.stream.DoubleStream
    public /* synthetic */ OptionalDouble min() {
        return AbstractC0033a.u(this.a.min());
    }
    ...
    public /* synthetic */ double reduce(double d, DoubleBinaryOperator doubleBinaryOperator) {
        return this.a.K(d, C0233y.a(doubleBinaryOperator));
    }

    @Override // java.util.stream.DoubleStream
    public /* synthetic */ OptionalDouble reduce(DoubleBinaryOperator doubleBinaryOperator) {
        return AbstractC0033a.u(this.a.G(C0233y.a(doubleBinaryOperator)));
    }
