...
public final /* synthetic */ class L0 implements j$.util.stream.U {
    ...
    public /* synthetic */ C0043j G(j$.util.function.d dVar) {
        return AbstractC0033a.q(this.a.reduce(C0234z.a(dVar)));
    }
    ...
    public /* synthetic */ double K(double d, j$.util.function.d dVar) {
        return this.a.reduce(d, C0234z.a(dVar));
    }
    ...
    @Override // j$.util.stream.U
    public /* synthetic */ C0043j findAny() {
        return AbstractC0033a.q(this.a.findAny());
    }

    @Override // j$.util.stream.U
    public /* synthetic */ C0043j findFirst() {
        return AbstractC0033a.q(this.a.findFirst());
    }
    ...
    @Override // j$.util.stream.U
    public /* synthetic */ C0043j max() {
        return AbstractC0033a.q(this.a.max());
    }

    @Override // j$.util.stream.U
    public /* synthetic */ C0043j min() {
        return AbstractC0033a.q(this.a.min());
    }
    ...
    @Override // j$.util.stream.U
    public C0040g summaryStatistics() {
    ...
    @Override // j$.util.stream.U
    public /* synthetic */ AbstractC0074e1 x(j$.util.function.h hVar) {
