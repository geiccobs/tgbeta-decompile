...
public final /* synthetic */ class C$r8$wrapper$java$util$stream$IntStream$VWRP implements IntStream {
    ...
    @Override // j$.util.stream.IntStream
    public /* synthetic */ C0045k a0(j$.util.function.j jVar) {
        return AbstractC0034a.r(this.a.reduce(P.a(jVar)));
    }
    ...
    @Override // j$.util.stream.IntStream
    public /* synthetic */ AbstractC0075e1 asLongStream() {
    ...
    @Override // j$.util.stream.IntStream
    public /* synthetic */ AbstractC0075e1 f(j$.util.function.n nVar) {
        return N0.n0(this.a.mapToLong(C0196a0.a(nVar)));
    }

    @Override // j$.util.stream.IntStream
    public /* synthetic */ C0045k findAny() {
        return AbstractC0034a.r(this.a.findAny());
    }

    @Override // j$.util.stream.IntStream
    public /* synthetic */ C0045k findFirst() {
        return AbstractC0034a.r(this.a.findFirst());
    }
    ...
    @Override // j$.util.stream.IntStream
    public /* synthetic */ C0045k max() {
        return AbstractC0034a.r(this.a.max());
    }

    @Override // j$.util.stream.IntStream
    public /* synthetic */ C0045k min() {
        return AbstractC0034a.r(this.a.min());
    }
    ...
    @Override // j$.util.stream.IntStream
    public /* synthetic */ IntStream q(C0198b0 c0198b0) {
        return convert(this.a.map(AbstractC0200c0.a(c0198b0)));
    }
    ...
    @Override // j$.util.stream.IntStream
    public C0042h summaryStatistics() {
