...
public enum a implements k {
    NANO_OF_SECOND("NanoOfSecond", r8, r17, n.c(0, 999999999)),
    ...
    YEAR_OF_ERA("YearOfEra", r42, r44, n.d(1, 999999999, 1000000000)),
    YEAR("Year", r42, r44, n.c(-999999999, 999999999), "year"),
