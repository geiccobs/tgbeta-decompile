...
public final class TemporalQueries {
    ...
    public static /* synthetic */ Chronology lambda$static$1(TemporalAccessor temporal) {
        return (Chronology) temporal.query(CHRONO);
    }

    public static /* synthetic */ TemporalUnit lambda$static$2(TemporalAccessor temporal) {
        return (TemporalUnit) temporal.query(PRECISION);
    }

    public static /* synthetic */ ZoneOffset lambda$static$3(TemporalAccessor temporal) {
    ...
    public static /* synthetic */ ZoneId lambda$static$4(TemporalAccessor temporal) {
        ZoneId zone = (ZoneId) temporal.query(ZONE_ID);
        return zone != null ? zone : (ZoneId) temporal.query(OFFSET);
    }

    public static /* synthetic */ LocalDate lambda$static$5(TemporalAccessor temporal) {
    ...
    public static /* synthetic */ LocalTime lambda$static$6(TemporalAccessor temporal) {
