...
public class MessageContainsEmojiButton extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public MessageContainsEmojiButton(int r12, android.content.Context r13, org.telegram.ui.ActionBar.Theme.ResourcesProvider r14, java.util.ArrayList<org.telegram.tgnet.TLRPC$InputStickerSet> r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.MessageContainsEmojiButton.<init>(int, android.content.Context, org.telegram.ui.ActionBar.Theme$ResourcesProvider, java.util.ArrayList):void");
    }
