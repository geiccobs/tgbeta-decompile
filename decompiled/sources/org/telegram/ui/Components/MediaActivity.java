...
public class MediaActivity extends BaseFragment implements SharedMediaLayout.SharedMediaPreloaderDelegate {
    ...
    /* JADX WARN: Type inference failed for: r6v13, types: [org.telegram.ui.ActionBar.ActionBar] */
    @Override // org.telegram.ui.ActionBar.BaseFragment
    public View createView(final Context context) {
        ...
        final SizeNotifierFrameLayout fragmentView = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.Components.MediaActivity.2
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                if (MediaActivity.this.actionBar.getOccupyStatusBar()) {
                    i = AndroidUtilities.statusBarHeight;
                }
                lp.topMargin = i;
                lp.height = ActionBar.getCurrentActionBarHeight();
                int textTop = (((ActionBar.getCurrentActionBarHeight() / 2) - AndroidUtilities.dp(22.0f)) / 2) + AndroidUtilities.dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 5.0f : 4.0f);
                ((FrameLayout.LayoutParams) MediaActivity.this.nameTextView.getLayoutParams()).topMargin = textTop;
                int textTop2 = ((ActionBar.getCurrentActionBarHeight() / 2) + (((ActionBar.getCurrentActionBarHeight() / 2) - AndroidUtilities.dp(19.0f)) / 2)) - AndroidUtilities.dp(3.0f);
                ((FrameLayout.LayoutParams) MediaActivity.this.mediaCounterTextView.getLayoutParams()).topMargin = textTop2;
            ...
            public boolean dispatchTouchEvent(MotionEvent ev) {
                if (MediaActivity.this.sharedMediaLayout != null && MediaActivity.this.sharedMediaLayout.isInFastScroll()) {
                    return MediaActivity.this.sharedMediaLayout.dispatchFastScrollEvent(ev);
                }
                if (MediaActivity.this.sharedMediaLayout != null && MediaActivity.this.sharedMediaLayout.checkPinchToZoom(ev)) {
                    return true;
                }
            ...
            public void drawList(Canvas blurCanvas, boolean top) {
                MediaActivity.this.sharedMediaLayout.drawListForBlur(blurCanvas);
            }
        };
        ...
        avatarContainer.addView(this.nameTextView, LayoutHelper.createFrame(-2, -2.0f, 51, 118.0f, 0.0f, 56.0f, 0.0f));
        ...
        avatarContainer.addView(this.avatarImageView, LayoutHelper.createFrame(42, 42.0f, 51, 64.0f, 0.0f, 0.0f, 0.0f));
        AudioPlayerAlert.ClippingTextViewSwitcher clippingTextViewSwitcher = new AudioPlayerAlert.ClippingTextViewSwitcher(context) { // from class: org.telegram.ui.Components.MediaActivity.4
        ...
        avatarContainer.addView(clippingTextViewSwitcher, LayoutHelper.createFrame(-2, -2.0f, 51, 118.0f, 0.0f, 56.0f, 0.0f));
        ...
        fragmentView.addView(this.sharedMediaLayout);
        fragmentView.addView(this.actionBar);
        fragmentView.addView(avatarContainer);
        fragmentView.blurBehindViews.add(this.sharedMediaLayout);
        ...
        ImageLocation thumbLocation = ImageLocation.getForUserOrChat(avatarObject, 1);
        this.avatarImageView.setImage(thumbLocation, "50_50", avatarDrawable, avatarObject);
        ...
        this.actionBar.setDrawBlurBackground(fragmentView);
        AndroidUtilities.updateViewVisibilityAnimated(avatarContainer, true, 1.0f, z);
        updateMediaCount();
        m2761x87fdda83();
        return fragmentView;
    }
    ...
    public void updateMediaCount() {
        ...
        if (id == 0) {
            if (this.sharedMediaLayout.getPhotosVideosTypeFilter() != 1) {
                if (this.sharedMediaLayout.getPhotosVideosTypeFilter() == 2) {
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ThemeDescription.ThemeDescriptionDelegate themeDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.Components.MediaActivity$$ExternalSyntheticLambda0
            @Override // org.telegram.ui.ActionBar.ThemeDescription.ThemeDescriptionDelegate
            public final void didSetColor() {
                MediaActivity.this.m2761x87fdda83();
            }
