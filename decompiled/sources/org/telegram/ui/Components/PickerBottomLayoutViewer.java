...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean darkTheme) {
        ...
        textView2.setBackgroundDrawable(Theme.createSelectorDrawable(z ? Theme.ACTION_BAR_PICKER_SELECTOR_COLOR : Theme.ACTION_BAR_AUDIO_SELECTOR_COLOR, 0));
        ...
        this.doneButton.setBackgroundDrawable(Theme.createSelectorDrawable(!this.isDarkTheme ? Theme.ACTION_BAR_AUDIO_SELECTOR_COLOR : i2, 0));
