...
public class ShaderSet {
    ...
    private static Map<String, Map<String, Object>> createMap() {
        ...
        hashMap5.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", RemoteMessageConst.Notification.COLOR});
        ...
        hashMap6.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", RemoteMessageConst.Notification.COLOR});
        ...
        hashMap7.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", RemoteMessageConst.Notification.COLOR});
        ...
        hashMap8.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", RemoteMessageConst.Notification.COLOR});
