...
public class SubstringLayoutAnimator {
    ...
    public void create(StaticLayout hintLayout, CharSequence hint, CharSequence text, TextPaint paint) {
        ...
        if (hintLayout != null && !hint.equals(text)) {
            ...
            if (startFrom < 0) {
                ...
                this.animateInLayout = new StaticLayout(inStr, paint, AndroidUtilities.dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                StaticLayout staticLayout = new StaticLayout(stabeStr, paint, AndroidUtilities.dp(400.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                this.animateStableLayout = staticLayout;
                this.animateTextChange = true;
                this.animateTextChangeOut = animateOut;
                this.xOffset = startFrom == 0 ? 0.0f : -staticLayout.getPrimaryHorizontal(startFrom);
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.SubstringLayoutAnimator$$ExternalSyntheticLambda0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    SubstringLayoutAnimator.this.m3117xebd39380(valueAnimator2);
                }
            });
    ...
    /* renamed from: lambda$create$0$org-telegram-ui-Components-SubstringLayoutAnimator */
    public /* synthetic */ void m3117xebd39380(ValueAnimator valueAnimator1) {
        ...
        if (this.animateTextChange) {
            ...
            if (this.animateInLayout != null) {
                ...
                if (this.replaceAnimation) {
                    float s = (p * 0.1f) + 0.9f;
                    canvas.scale(s, s, titleOffsetX, this.parentView.getMeasuredHeight() / 2.0f);
                }
            ...
            if (this.animateOutLayout != null) {
                ...
                if (this.replaceAnimation) {
                    ...
                    canvas.scale(s2, s2, titleOffsetX, this.parentView.getMeasuredHeight() / 2.0f);
                }
