...
public class TextCheckbox2Cell extends FrameLayout {
    ...
    public TextCheckbox2Cell(Context context, int padding, boolean dialog) {
        ...
        addView(this.checkbox, LayoutHelper.createFrame(20, 20.0f, (!LocaleController.isRTL ? 3 : i) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
    ...
    public void setBackgroundColorAnimated(boolean checked, int color) {
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Cells.TextCheckbox2Cell.2
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                TextCheckbox2Cell.this.animatedColorBackground = 0;
