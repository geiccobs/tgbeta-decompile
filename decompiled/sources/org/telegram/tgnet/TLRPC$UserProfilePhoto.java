    ...
    public static TLRPC$UserProfilePhoto TLdeserialize(AbstractSerializedData abstractSerializedData, int i, boolean z) {
        ...
        switch (i) {
            case -2100168954:
                ...
                break;
            case -1727196013:
                tLRPC$UserProfilePhoto = new TLRPC$TL_userProfilePhoto() { // from class: org.telegram.tgnet.TLRPC$TL_userProfilePhoto_old
                ...
                break;
            case -865771401:
                tLRPC$UserProfilePhoto = new TLRPC$TL_userProfilePhoto() { // from class: org.telegram.tgnet.TLRPC$TL_userProfilePhoto_layer127
                ...
                break;
            case -715532088:
                tLRPC$UserProfilePhoto = new TLRPC$TL_userProfilePhoto() { // from class: org.telegram.tgnet.TLRPC$TL_userProfilePhoto_layer97
                ...
                break;
            case -321430132:
                tLRPC$UserProfilePhoto = new TLRPC$TL_userProfilePhoto() { // from class: org.telegram.tgnet.TLRPC$TL_userProfilePhoto_layer115
            ...
            case 1326562017:
                ...
                break;
            case 1775479590:
                tLRPC$UserProfilePhoto = new TLRPC$TL_userProfilePhoto() { // from class: org.telegram.tgnet.TLRPC$TL_userProfilePhoto_layer126
