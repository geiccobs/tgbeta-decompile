...
public class SharedPrefsHelper {
    ...
    public static boolean isWebViewConfirmShown(int currentAccount, long botId) {
        return webViewBotsPrefs.getBoolean(String.format(WEB_VIEW_SHOWN_DIALOG_FORMAT, Integer.valueOf(currentAccount), Long.valueOf(botId)), false);
    }

    public static void setWebViewConfirmShown(int currentAccount, long botId, boolean shown) {
        webViewBotsPrefs.edit().putBoolean(String.format(WEB_VIEW_SHOWN_DIALOG_FORMAT, Integer.valueOf(currentAccount), Long.valueOf(botId)), shown).apply();
    }
