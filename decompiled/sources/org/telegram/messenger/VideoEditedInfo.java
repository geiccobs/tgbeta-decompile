            ...
            if (args.length >= 11) {
                ...
                if (args[11].startsWith("-")) {
                    ...
                    if (s.length() > 0) {
                        ...
                        byte has2 = serializedData.readByte(false);
                        if (has2 != 0) {
                            byte[] bytes = serializedData.readByteArray(false);
                            this.paintPath = new String(bytes);
                        }
                        byte has3 = serializedData.readByte(false);
                        if (has3 != 0) {
                        ...
                        if (version >= 2) {
                            byte has4 = serializedData.readByte(false);
                            if (has4 != 0) {
                ...
                for (int a3 = start; a3 < args.length; a3++) {
