...
class ContactsRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int i) {
        ...
        if (this.deleted) {
            ...
            remoteViews2.setTextViewText(org.telegram.messenger.beta.R.id.widget_edititem_text, LocaleController.getString("TapToEditWidgetShort", org.telegram.messenger.beta.R.string.TapToEditWidgetShort));
            ...
            RemoteViews remoteViews3 = new RemoteViews(this.mContext.getPackageName(), (int) org.telegram.messenger.beta.R.layout.contacts_widget_item);
            int i3 = 0;
            while (i3 < 2) {
                int i4 = (i * 2) + i3;
                if (i4 >= this.dids.size()) {
                    remoteViews3.setViewVisibility(i3 == 0 ? org.telegram.messenger.beta.R.id.contacts_widget_item1 : org.telegram.messenger.beta.R.id.contacts_widget_item2, 4);
                } else {
                    remoteViews3.setViewVisibility(i3 == 0 ? org.telegram.messenger.beta.R.id.contacts_widget_item1 : org.telegram.messenger.beta.R.id.contacts_widget_item2, 0);
                    ...
                    if (DialogObject.isUserDialog(l.longValue())) {
                        ...
                        if (UserObject.isUserSelf(tLRPC$User)) {
                            ...
                            str = LocaleController.getString("HiddenName", org.telegram.messenger.beta.R.string.HiddenName);
                        } else {
                    ...
                    remoteViews3.setTextViewText(i3 == 0 ? org.telegram.messenger.beta.R.id.contacts_widget_item_text1 : org.telegram.messenger.beta.R.id.contacts_widget_item_text2, str);
                    ...
                    remoteViews3.setImageViewBitmap(i3 == 0 ? org.telegram.messenger.beta.R.id.contacts_widget_item_avatar1 : org.telegram.messenger.beta.R.id.contacts_widget_item_avatar2, createBitmap);
                    TLRPC$Dialog tLRPC$Dialog = this.dialogs.get(l.longValue());
                    int i5 = org.telegram.messenger.beta.R.id.contacts_widget_item_badge_bg1;
                    if (tLRPC$Dialog != null && (i2 = tLRPC$Dialog.unread_count) > 0) {
                        remoteViews3.setTextViewText(i3 == 0 ? org.telegram.messenger.beta.R.id.contacts_widget_item_badge1 : org.telegram.messenger.beta.R.id.contacts_widget_item_badge2, i2 > 99 ? String.format("%d+", 99) : String.format("%d", Integer.valueOf(i2)));
                        if (i3 != 0) {
                            i5 = org.telegram.messenger.beta.R.id.contacts_widget_item_badge_bg2;
                        }
                    ...
                    remoteViews3.setOnClickFillInIntent(i3 == 0 ? org.telegram.messenger.beta.R.id.contacts_widget_item1 : org.telegram.messenger.beta.R.id.contacts_widget_item2, intent2);
                }
                i3++;
            }
            return remoteViews3;
