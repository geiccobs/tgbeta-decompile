...
public class NotificationCenter {
    ...
    static {
        ...
        int i156 = i155 + 1;
        totalEvents = i156;
        didUpdatePremiumGiftStickers = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        pushMessagesUpdated = i156;
        int i158 = i157 + 1;
        totalEvents = i158;
        stopEncodingService = i157;
        int i159 = i158 + 1;
        totalEvents = i159;
        wallpapersDidLoad = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        wallpapersNeedReload = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        didReceiveSmsCode = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        didReceiveCall = i161;
        int i163 = i162 + 1;
        ...
        int i164 = i163 + 1;
        totalEvents = i164;
        invalidateMotionBackground = i163;
        int i165 = i164 + 1;
        totalEvents = i165;
        closeOtherAppActivities = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        cameraInitied = i165;
        int i167 = i166 + 1;
        totalEvents = i167;
        didReplacedPhotoInMemCache = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        didSetNewTheme = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        themeListUpdated = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        didApplyNewTheme = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        themeAccentListUpdated = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        needCheckSystemBarColors = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        needShareTheme = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        needSetDayNightTheme = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        goingToPreviewTheme = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        locationPermissionGranted = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        locationPermissionDenied = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        reloadInterface = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        suggestedLangpack = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        didSetNewWallpapper = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        proxySettingsChanged = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        proxyCheckDone = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        liveLocationsChanged = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        newLocationAvailable = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        liveLocationsCacheChanged = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        notificationsCountUpdated = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        playerDidStartPlaying = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        closeSearchByActiveAction = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        messagePlayingSpeedChanged = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        screenStateChanged = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        didClearDatabase = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        voipServiceCreated = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        webRtcMicAmplitudeEvent = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        webRtcSpeakerAmplitudeEvent = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        showBulletin = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        appUpdateAvailable = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        onDatabaseMigration = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        onEmojiInteractionsReceived = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        emojiPreviewThemesChanged = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        reactionsDidLoad = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        attachMenuBotsDidLoad = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        chatAvailableReactionsUpdated = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        dialogsUnreadReactionsCounterChanged = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        onDatabaseOpened = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        onDownloadingFilesChanged = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        onActivityResultReceived = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        onRequestPermissionResultReceived = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        onUserRingtonesUpdated = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        currentUserPremiumStatusChanged = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        premiumPromoUpdated = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        premiumStatusChangedGlobal = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        currentUserShowLimitReachedDialog = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        billingProductDetailsUpdated = i212;
        totalEvents = i213 + 1;
        premiumStickersPreviewLoaded = i213;
    }
