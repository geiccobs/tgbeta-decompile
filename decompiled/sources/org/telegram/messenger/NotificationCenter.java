...
public class NotificationCenter {
    ...
    static {
        ...
        int i95 = i94 + 1;
        totalEvents = i95;
        didVerifyMessagesStickers = i94;
        int i96 = i95 + 1;
        totalEvents = i96;
        scheduledMessagesUpdated = i95;
        int i97 = i96 + 1;
        totalEvents = i97;
        newSuggestionsAvailable = i96;
        int i98 = i97 + 1;
        totalEvents = i98;
        didLoadChatInviter = i97;
        int i99 = i98 + 1;
        totalEvents = i99;
        didLoadChatAdmins = i98;
        int i100 = i99 + 1;
        totalEvents = i100;
        historyImportProgressChanged = i99;
        int i101 = i100 + 1;
        totalEvents = i101;
        stickersImportProgressChanged = i100;
        int i102 = i101 + 1;
        totalEvents = i102;
        stickersImportComplete = i101;
        int i103 = i102 + 1;
        totalEvents = i103;
        dialogDeleted = i102;
        int i104 = i103 + 1;
        totalEvents = i104;
        webViewResultSent = i103;
        int i105 = i104 + 1;
        totalEvents = i105;
        voiceTranscriptionUpdate = i104;
        int i106 = i105 + 1;
        totalEvents = i106;
        didGenerateFingerprintKeyPair = i105;
        int i107 = i106 + 1;
        totalEvents = i107;
        walletPendingTransactionsChanged = i106;
        int i108 = i107 + 1;
        totalEvents = i108;
        walletSyncProgressChanged = i107;
        int i109 = i108 + 1;
        totalEvents = i109;
        httpFileDidLoad = i108;
        int i110 = i109 + 1;
        totalEvents = i110;
        httpFileDidFailedLoad = i109;
        int i111 = i110 + 1;
        totalEvents = i111;
        didUpdateConnectionState = i110;
        int i112 = i111 + 1;
        totalEvents = i112;
        fileUploaded = i111;
        int i113 = i112 + 1;
        totalEvents = i113;
        fileUploadFailed = i112;
        int i114 = i113 + 1;
        totalEvents = i114;
        fileUploadProgressChanged = i113;
        int i115 = i114 + 1;
        totalEvents = i115;
        fileLoadProgressChanged = i114;
        int i116 = i115 + 1;
        totalEvents = i116;
        fileLoaded = i115;
        int i117 = i116 + 1;
        ...
        int i118 = i117 + 1;
        totalEvents = i118;
        filePreparingStarted = i117;
        int i119 = i118 + 1;
        totalEvents = i119;
        fileNewChunkAvailable = i118;
        int i120 = i119 + 1;
        totalEvents = i120;
        filePreparingFailed = i119;
        int i121 = i120 + 1;
        totalEvents = i121;
        dialogsUnreadCounterChanged = i120;
        int i122 = i121 + 1;
        totalEvents = i122;
        messagePlayingProgressDidChanged = i121;
        int i123 = i122 + 1;
        totalEvents = i123;
        messagePlayingDidReset = i122;
        int i124 = i123 + 1;
        totalEvents = i124;
        messagePlayingPlayStateChanged = i123;
        int i125 = i124 + 1;
        totalEvents = i125;
        messagePlayingDidStart = i124;
        int i126 = i125 + 1;
        totalEvents = i126;
        messagePlayingDidSeek = i125;
        int i127 = i126 + 1;
        totalEvents = i127;
        messagePlayingGoingToStop = i126;
        int i128 = i127 + 1;
        totalEvents = i128;
        recordProgressChanged = i127;
        int i129 = i128 + 1;
        totalEvents = i129;
        recordStarted = i128;
        int i130 = i129 + 1;
        totalEvents = i130;
        recordStartError = i129;
        int i131 = i130 + 1;
        totalEvents = i131;
        recordStopped = i130;
        int i132 = i131 + 1;
        ...
        int i135 = i134 + 1;
        totalEvents = i135;
        audioRecordTooShort = i134;
        int i136 = i135 + 1;
        totalEvents = i136;
        audioRouteChanged = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        didStartedCall = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        groupCallUpdated = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        groupCallSpeakingUsersUpdated = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        groupCallScreencastStateChanged = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        activeGroupCallsUpdated = i140;
        int i142 = i141 + 1;
        totalEvents = i142;
        applyGroupCallVisibleParticipants = i141;
        int i143 = i142 + 1;
        totalEvents = i143;
        groupCallTypingsUpdated = i142;
        int i144 = i143 + 1;
        totalEvents = i144;
        didEndCall = i143;
        int i145 = i144 + 1;
        totalEvents = i145;
        closeInCallActivity = i144;
        int i146 = i145 + 1;
        totalEvents = i146;
        groupCallVisibilityChanged = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        appDidLogout = i146;
        int i148 = i147 + 1;
        ...
        int i149 = i148 + 1;
        totalEvents = i149;
        needDeleteDialog = i148;
        int i150 = i149 + 1;
        totalEvents = i150;
        newEmojiSuggestionsAvailable = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        themeUploadedToServer = i150;
        int i152 = i151 + 1;
        totalEvents = i152;
        themeUploadError = i151;
        int i153 = i152 + 1;
        totalEvents = i153;
        dialogFiltersUpdated = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        filterSettingsUpdated = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        suggestedFiltersLoaded = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        updateBotMenuButton = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        didUpdatePremiumGiftStickers = i156;
        int i158 = i157 + 1;
        totalEvents = i158;
        pushMessagesUpdated = i157;
        int i159 = i158 + 1;
        totalEvents = i159;
        stopEncodingService = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        wallpapersDidLoad = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        wallpapersNeedReload = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        didReceiveSmsCode = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        didReceiveCall = i162;
        int i164 = i163 + 1;
        ...
        int i165 = i164 + 1;
        totalEvents = i165;
        invalidateMotionBackground = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        closeOtherAppActivities = i165;
        int i167 = i166 + 1;
        totalEvents = i167;
        cameraInitied = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        didReplacedPhotoInMemCache = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        didSetNewTheme = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        themeListUpdated = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        didApplyNewTheme = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        themeAccentListUpdated = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        needCheckSystemBarColors = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        needShareTheme = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        needSetDayNightTheme = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        goingToPreviewTheme = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        locationPermissionGranted = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        locationPermissionDenied = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        reloadInterface = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        suggestedLangpack = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        didSetNewWallpapper = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        proxySettingsChanged = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        proxyCheckDone = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        liveLocationsChanged = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        newLocationAvailable = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        liveLocationsCacheChanged = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        notificationsCountUpdated = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        playerDidStartPlaying = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        closeSearchByActiveAction = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        messagePlayingSpeedChanged = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        screenStateChanged = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        didClearDatabase = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        voipServiceCreated = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        webRtcMicAmplitudeEvent = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        webRtcSpeakerAmplitudeEvent = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        showBulletin = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        appUpdateAvailable = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        onDatabaseMigration = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        onEmojiInteractionsReceived = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        emojiPreviewThemesChanged = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        reactionsDidLoad = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        attachMenuBotsDidLoad = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        chatAvailableReactionsUpdated = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        dialogsUnreadReactionsCounterChanged = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        onDatabaseOpened = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        onDownloadingFilesChanged = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        onActivityResultReceived = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        onRequestPermissionResultReceived = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        onUserRingtonesUpdated = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        currentUserPremiumStatusChanged = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        premiumPromoUpdated = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        premiumStatusChangedGlobal = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        currentUserShowLimitReachedDialog = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        billingProductDetailsUpdated = i213;
        totalEvents = i214 + 1;
        premiumStickersPreviewLoaded = i214;
    }
