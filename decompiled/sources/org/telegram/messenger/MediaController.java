    ...
    */
    public static /* synthetic */ void lambda$checkGallery$1(int r13) {
        /*
            ...
            r3 = 0
            r4 = 0
            android.content.Context r5 = org.telegram.messenger.ApplicationLoader.applicationContext     // Catch: java.lang.Throwable -> L3a
        ...
        L3a:
            ...
            r5 = r3
        L3c:
            org.telegram.messenger.FileLog.e(r6)     // Catch: java.lang.Throwable -> L90
            if (r5 == 0) goto L44
            r5.close()
        L44:
            r6 = 0
        L45:
            android.content.Context r7 = org.telegram.messenger.ApplicationLoader.applicationContext     // Catch: java.lang.Throwable -> L73
            int r1 = r7.checkSelfPermission(r1)     // Catch: java.lang.Throwable -> L73
            if (r1 != 0) goto L6d
            android.content.Context r1 = org.telegram.messenger.ApplicationLoader.applicationContext     // Catch: java.lang.Throwable -> L73
        ...
        L73:
            r0 = move-exception
            org.telegram.messenger.FileLog.e(r0)     // Catch: java.lang.Throwable -> L89
            if (r5 == 0) goto L7a
            goto L6f
        L7a:
            if (r13 == r6) goto L88
    ...
    */
    public void processMediaObserver(android.net.Uri r14) {
        ...
        Lb1:
            ...
            if (r1 != 0) goto Lbf
            org.telegram.messenger.MediaController$$ExternalSyntheticLambda27 r1 = new org.telegram.messenger.MediaController$$ExternalSyntheticLambda27     // Catch: java.lang.Throwable -> Lc5 java.lang.Exception -> Lc7
            ...
            if (this.pipRoundVideoView != null || !MessagesController.getInstance(messageObject.currentAccount).isDialogVisible(messageObject.getDialogId(), messageObject.scheduled)) {
                if (this.pipRoundVideoView == null) {
                    try {
                        ...
                        pipRoundVideoView.show(this.baseActivity, new Runnable() { // from class: org.telegram.messenger.MediaController$$ExternalSyntheticLambda12
                            @Override // java.lang.Runnable
                            public final void run() {
    ...
    */
    public static void saveFile(java.lang.String r13, android.content.Context r14, final int r15, final java.lang.String r16, final java.lang.String r17, final java.lang.Runnable r18) {
        ...
        L2b:
            ...
            if (r15 == 0) goto L6b
            org.telegram.ui.ActionBar.AlertDialog r4 = new org.telegram.ui.ActionBar.AlertDialog     // Catch: java.lang.Exception -> L67
            r5 = 2
            ...
            org.telegram.messenger.MediaController$$ExternalSyntheticLambda1 r0 = new org.telegram.messenger.MediaController$$ExternalSyntheticLambda1     // Catch: java.lang.Exception -> L67
            r0.<init>()     // Catch: java.lang.Exception -> L67
            r4.setOnCancelListener(r0)     // Catch: java.lang.Exception -> L67
            org.telegram.messenger.MediaController$$ExternalSyntheticLambda39 r0 = new org.telegram.messenger.MediaController$$ExternalSyntheticLambda39     // Catch: java.lang.Exception -> L67
            r0.<init>()     // Catch: java.lang.Exception -> L67
            r1 = 250(0xfa, double:1.235E-321)
            org.telegram.messenger.AndroidUtilities.runOnUIThread(r0, r1)     // Catch: java.lang.Exception -> L67
            r8 = r4
            goto L6c
        L67:
            r0 = move-exception
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static /* synthetic */ void lambda$saveFile$38(int r20, java.io.File r21, java.lang.String r22, final org.telegram.ui.ActionBar.AlertDialog r23, boolean[] r24, java.lang.String r25, java.lang.Runnable r26, final boolean[] r27) {
        /*
