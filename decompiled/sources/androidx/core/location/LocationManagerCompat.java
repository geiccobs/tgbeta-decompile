...
public final class LocationManagerCompat {
    ...
    private static class Api30Impl {
        ...
        static void getCurrentLocation(LocationManager locationManager, String provider, CancellationSignal cancellationSignal, Executor executor, final Consumer<Location> consumer) {
            ...
            locationManager.getCurrentLocation(provider, cancellationSignal2, executor, C$r8$wrapper$java$util$function$Consumer$WRP.convert(new j$.util.function.Consumer<Location>() { // from class: androidx.core.location.LocationManagerCompat.Api30Impl.1
                @Override // j$.util.function.Consumer
                public /* synthetic */ j$.util.function.Consumer<Location> andThen(j$.util.function.Consumer<? super Location> consumer2) {
