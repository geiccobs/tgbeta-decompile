                ...
                switch (cmd) {
                    ...
                    case 'S':
                        ...
                        if (previousCmd3 != 'c' && previousCmd3 != 's' && previousCmd3 != 'C' && previousCmd3 != 'S') {
                            ...
                            reflectiveCtrlPointY = currentY5;
                        } else {
                            float reflectiveCtrlPointX3 = (currentX5 * 2.0f) - ctrlPointX2;
                            float reflectiveCtrlPointY3 = (currentY5 * 2.0f) - ctrlPointY2;
                    ...
                    case 'a':
                        ...
                        k = k2;
                        drawArc(path, currentX2, currentY7, val[k2 + 5] + currentX2, val[k2 + 6] + currentY7, val[k2 + 0], val[k2 + 1], val[k2 + 2], val[k2 + 3] != 0.0f, val[k2 + 4] != 0.0f);
                        currentX2 += val[k + 5];
                        currentY2 = currentY7 + val[k + 6];
                        path2 = path;
                    ...
                    case 'c':
                        ...
                        float ctrlPointY3 = currentY8 + val[k2 + 3];
                        currentX2 += val[k2 + 4];
                        ctrlPointX2 = ctrlPointX3;
                        ctrlPointY2 = ctrlPointY3;
                        k = k2;
                        currentY2 = val[k2 + 5] + currentY8;
                        break;
                    case LocationRequest.PRIORITY_LOW_POWER /* 104 */:
                    ...
                    case 'q':
                        ...
                        float ctrlPointY4 = currentY9 + val[k2 + 1];
                        currentX2 += val[k2 + 2];
                        ctrlPointX2 = ctrlPointX4;
                        ctrlPointY2 = ctrlPointY4;
                        k = k2;
                        currentY2 = val[k2 + 3] + currentY9;
                        break;
                    case 's':
                        ...
                        float ctrlPointY5 = currentY10 + val[k2 + 1];
                        currentX2 += val[k2 + 2];
                        ctrlPointX2 = ctrlPointX5;
                        ctrlPointY2 = ctrlPointY5;
                        k = k2;
                        currentY2 = val[k2 + 3] + currentY10;
                        break;
                    case 't':
