...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_IME_ENTER = new AccessibilityActionCompat(accessibilityAction2, 16908372, null, null, null);
        }
    ...
    private void setBooleanProperty(int property, boolean value) {
        ...
        if (extras != null) {
            ...
            int booleanProperties2 = booleanProperties & (property ^ (-1));
            if (value) {
                i = property;
            }
            extras.putInt(BOOLEAN_PROPERTY_KEY, i | booleanProperties2);
        }
    }
