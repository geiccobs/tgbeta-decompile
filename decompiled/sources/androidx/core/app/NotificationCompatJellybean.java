...
public class NotificationCompatJellybean {
    ...
    private static RemoteInput fromBundle(Bundle data) {
        ...
        return new RemoteInput(data.getString(KEY_RESULT_KEY), data.getCharSequence("label"), data.getCharSequenceArray(KEY_CHOICES), data.getBoolean(KEY_ALLOW_FREE_FORM_INPUT), 0, data.getBundle(KEY_EXTRAS), allowedDataTypes);
    }
