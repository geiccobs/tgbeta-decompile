        ...
        if (widthMode != 1073741824) {
            if (isInEditMode()) {
                if (widthMode == Integer.MIN_VALUE) {
                    widthMode = C.BUFFER_FLAG_ENCRYPTED;
                } else if (widthMode == 0) {
                    widthMode = C.BUFFER_FLAG_ENCRYPTED;
                    widthSize = 300;
                }
                ...
                if (child.getVisibility() == 8) {
                    ...
                    if (lp.width == -2) {
                        ...
                        if (childWidthSpec2 == -1) {
                            childWidthSpec = View.MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, C.BUFFER_FLAG_ENCRYPTED);
                        } else {
                            childWidthSpec = View.MeasureSpec.makeMeasureSpec(lp.width, C.BUFFER_FLAG_ENCRYPTED);
                        }
                    }
                    if (lp.height == -2) {
                        childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, Integer.MIN_VALUE);
                    } else if (lp.height == -1) {
                        childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, C.BUFFER_FLAG_ENCRYPTED);
                    } else {
                        childHeightSpec3 = View.MeasureSpec.makeMeasureSpec(lp.height, C.BUFFER_FLAG_ENCRYPTED);
                    }
                                ...
                                if (!canSlide || child2 == this.mSlideableView) {
                                    ...
                                    if (lp2.weight <= 0.0f) {
                                        ...
                                        if (lp2.width == 0) {
                                            if (lp2.height == -2) {
                                                ...
                                                childHeightSpec = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, C.BUFFER_FLAG_ENCRYPTED);
                                            } else {
                                                childHeightSpec = View.MeasureSpec.makeMeasureSpec(lp2.height, C.BUFFER_FLAG_ENCRYPTED);
                                            }
                                        } else {
                                            childHeightSpec = View.MeasureSpec.makeMeasureSpec(child2.getMeasuredHeight(), C.BUFFER_FLAG_ENCRYPTED);
                                        }
                                        if (canSlide) {
                                            int newWidth = widthAvailable - (lp2.leftMargin + lp2.rightMargin);
                                            fixedPanelWidthLimit = fixedPanelWidthLimit2;
                                            maxLayoutHeight = maxLayoutHeight2;
                                            int childWidthSpec3 = View.MeasureSpec.makeMeasureSpec(newWidth, C.BUFFER_FLAG_ENCRYPTED);
                                            ...
                                            int childWidthSpec4 = View.MeasureSpec.makeMeasureSpec(measuredWidth + addedWidth, C.BUFFER_FLAG_ENCRYPTED);
                                    ...
                                    if (skippedFirstPass) {
                                        ...
                                        if (lp2.height == -2) {
                                            ...
                                            i = C.BUFFER_FLAG_ENCRYPTED;
                                            childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(maxLayoutHeight2, C.BUFFER_FLAG_ENCRYPTED);
                                        } else {
                                            i = C.BUFFER_FLAG_ENCRYPTED;
                                            childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(lp2.height, C.BUFFER_FLAG_ENCRYPTED);
                                        }
                                    } else {
                                        childCount = childCount2;
                                        i = C.BUFFER_FLAG_ENCRYPTED;
                                        childHeightSpec2 = View.MeasureSpec.makeMeasureSpec(child2.getMeasuredHeight(), C.BUFFER_FLAG_ENCRYPTED);
                                    }
