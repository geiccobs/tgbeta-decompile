...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, C.BUFFER_FLAG_ENCRYPTED), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, C.BUFFER_FLAG_ENCRYPTED));
        this.mCircleViewIndex = -1;
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        double d = dragPercent;
        Double.isNaN(d);
        float adjustedPercent = (((float) Math.max(d - 0.4d, (double) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE)) * 5.0f) / 3.0f;
        ...
        double d2 = tensionSlingshotPercent / 4.0f;
        double pow = Math.pow(tensionSlingshotPercent / 4.0f, 2.0d);
        Double.isNaN(d2);
