...
public class QuicktimeTextSampleEntry extends AbstractSampleEntry {
    ...
    public void getBox(WritableByteChannel writableByteChannel) throws IOException {
        ...
        ByteBuffer byteBuffer = ByteBuffer.allocate((str != null ? str.length() : 0) + 52);
        ...
        if (str2 != null) {
            IsoTypeWriter.writeUInt8(byteBuffer, str2.length());
    ...
    public long getSize() {
        ...
        String str = this.fontName;
        long s = containerSize + (str != null ? str.length() : 0);
        return s + ((this.largeBox || 8 + s >= 4294967296L) ? 16 : 8);
    }
