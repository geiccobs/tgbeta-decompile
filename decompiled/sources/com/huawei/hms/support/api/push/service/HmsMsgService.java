...
public class HmsMsgService extends Service {
    ...
    private static class a extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (ObjectsCompat$$ExternalSyntheticBackport0.m(this.a.getApplicationContext().getPackageManager().getNameForUid(message.sendingUid), HMSPackageManager.getInstance(this.a).getHMSPackageName()) && data != null) {
                if (HMSPackageManager.getInstance(this.a).getHMSPackageStates() != PackageManagerHelper.PackageStates.ENABLED) {
                    ...
                    if (ObjectsCompat$$ExternalSyntheticBackport0.m(c.b(data, "push_action"), "com.huawei.push.msg.NOTIFY_MSG")) {
                    ...
                    } else if (ObjectsCompat$$ExternalSyntheticBackport0.m(c.b(data, "push_action"), "com.huawei.push.msg.PASSBY_MSG")) {
