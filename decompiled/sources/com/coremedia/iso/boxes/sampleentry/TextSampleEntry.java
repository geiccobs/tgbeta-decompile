...
public class TextSampleEntry extends AbstractSampleEntry {
    ...
    public void parse(DataSource dataSource, ByteBuffer header, long contentSize, BoxParser boxParser) throws IOException {
        ...
        iArr[0] = IsoTypeReader.readUInt8(content);
    ...
    public static class StyleRecord {
        ...
        public void parse(ByteBuffer in) {
            ...
            int[] iArr = new int[4];
            this.textColor = iArr;
            iArr[0] = IsoTypeReader.readUInt8(in);
        ...
        public int hashCode() {
            ...
            int result2 = ((((((((result * 31) + this.endChar) * 31) + this.fontId) * 31) + this.faceStyleFlags) * 31) + this.fontSize) * 31;
            int[] iArr = this.textColor;
            return result2 + (iArr != null ? Arrays.hashCode(iArr) : 0);
        }
    ...
    public long getSize() {
        ...
        return s + 38 + ((this.largeBox || s + 38 >= 4294967296L) ? 16 : 8);
    }
}
