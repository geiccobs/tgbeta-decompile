        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    zabVar = (com.google.android.gms.common.server.converter.zab) SafeParcelReader.createParcelable(parcel, readHeader, com.google.android.gms.common.server.converter.zab.CREATOR);
                    break;
                default:
