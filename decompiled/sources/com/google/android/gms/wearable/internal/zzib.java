...
public final class zzib {
    ...
    static final boolean zzc(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return zze(packageInfo, zza, zzb);
        }
        return zze(packageInfo, zza);
    }
    ...
    private static final boolean zze(PackageInfo packageInfo, byte[]... bArr) {
    ...
    public final boolean zzb(String str) {
        ...
        try {
            packageInfo = Wrappers.packageManager(this.zzd).getPackageInfo("com.google.android.wearable.app.cn", 64);
        ...
        if (GooglePlayServicesUtilLight.honorsDebugCertificates(this.zzd)) {
            return zzc(packageInfo, true);
        }
        boolean zzc2 = zzc(packageInfo, false);
        if (zzc2 || !zzc(packageInfo, true)) {
            return zzc2;
        }
