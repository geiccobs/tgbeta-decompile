        ...
        public final void zzb(int i) throws IOException {
            if (zzii.zzc && !zzhi.zza() && zza() >= 5) {
                if ((i & (-128)) == 0) {
                    ...
                    int i2 = this.zze;
                    this.zze = i2 + 1;
                    zzma.zza(bArr, i2, (byte) i);
                    return;
                }
                byte[] bArr2 = this.zzb;
                int i3 = this.zze;
                this.zze = i3 + 1;
                zzma.zza(bArr2, i3, (byte) (i | 128));
                int i4 = i >>> 7;
                if ((i4 & (-128)) == 0) {
                    byte[] bArr3 = this.zzb;
                    int i5 = this.zze;
                    this.zze = i5 + 1;
                    zzma.zza(bArr3, i5, (byte) i4);
                    return;
                }
                byte[] bArr4 = this.zzb;
                int i6 = this.zze;
                this.zze = i6 + 1;
                zzma.zza(bArr4, i6, (byte) (i4 | 128));
                int i7 = i4 >>> 7;
                if ((i7 & (-128)) == 0) {
                    byte[] bArr5 = this.zzb;
                    int i8 = this.zze;
                    this.zze = i8 + 1;
                    zzma.zza(bArr5, i8, (byte) i7);
                    return;
                }
                byte[] bArr6 = this.zzb;
                int i9 = this.zze;
                this.zze = i9 + 1;
                zzma.zza(bArr6, i9, (byte) (i7 | 128));
                int i10 = i7 >>> 7;
                if ((i10 & (-128)) == 0) {
                    byte[] bArr7 = this.zzb;
                    int i11 = this.zze;
                    this.zze = i11 + 1;
                    zzma.zza(bArr7, i11, (byte) i10);
                    return;
                }
                byte[] bArr8 = this.zzb;
                int i12 = this.zze;
                this.zze = i12 + 1;
                zzma.zza(bArr8, i12, (byte) (i10 | 128));
                byte[] bArr9 = this.zzb;
                int i13 = this.zze;
                this.zze = i13 + 1;
                zzma.zza(bArr9, i13, (byte) (i10 >>> 7));
                return;
            }
            while ((i & (-128)) != 0) {
                try {
