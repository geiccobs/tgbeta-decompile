    ...
    public static class zza extends zzii {
        ...
        public final void zzb(int i) throws IOException {
            if (!zzii.zzc || zzhi.zza() || zza() < 5) {
                ...
                int i5 = this.zze;
                this.zze = i5 + 1;
                zzma.zza(bArr4, i5, (byte) (i | ConnectionsManager.RequestFlagNeedQuickAck));
                int i6 = i >>> 7;
                if ((i6 & (-128)) == 0) {
                    byte[] bArr5 = this.zzb;
                    int i7 = this.zze;
                ...
                int i8 = this.zze;
                this.zze = i8 + 1;
                zzma.zza(bArr6, i8, (byte) (i6 | ConnectionsManager.RequestFlagNeedQuickAck));
                int i9 = i6 >>> 7;
                if ((i9 & (-128)) == 0) {
                    byte[] bArr7 = this.zzb;
                    int i10 = this.zze;
                ...
                int i11 = this.zze;
                this.zze = i11 + 1;
                zzma.zza(bArr8, i11, (byte) (i9 | ConnectionsManager.RequestFlagNeedQuickAck));
                int i12 = i9 >>> 7;
                if ((i12 & (-128)) == 0) {
                    byte[] bArr9 = this.zzb;
                    int i13 = this.zze;
                ...
                int i14 = this.zze;
                this.zze = i14 + 1;
                zzma.zza(bArr10, i14, (byte) (i12 | ConnectionsManager.RequestFlagNeedQuickAck));
        ...
        public final void zza(long j) throws IOException {
            if (zzii.zzc && zza() >= 10) {
                while ((j & (-128)) != 0) {
                    ...
                    int i = this.zze;
                    this.zze = i + 1;
                    zzma.zza(bArr, i, (byte) ((((int) j) & 127) | ConnectionsManager.RequestFlagNeedQuickAck));
                    j >>>= 7;
                }
                byte[] bArr2 = this.zzb;
                int i2 = this.zze;
