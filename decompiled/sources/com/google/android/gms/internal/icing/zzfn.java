...
final class zzfn {
    ...
    static {
        ...
        if (zzq != null) {
            if (zzr) {
                zzfmVar2 = new zzfl(zzq);
            } else if (zzr2) {
                zzfmVar2 = new zzfk(zzq);
            }
        }
        zzg = zzfmVar2;
        boolean z3 = true;
    ...
    public static void zzD(Object obj, long j, byte b) {
        ...
        zzfm zzfmVar = zzg;
        int i = ((((int) j) ^ (-1)) & 3) << 3;
        zzfmVar.zzl(obj, j2, ((255 & b) << i) | (zzfmVar.zzk(obj, j2) & ((255 << i) ^ (-1))));
    }
