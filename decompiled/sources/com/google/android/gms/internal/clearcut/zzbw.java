...
final /* synthetic */ class zzbw {
    ...
    static {
        ...
        try {
            zzgq[zzfl.UINT32.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            zzgq[zzfl.SFIXED32.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            zzgq[zzfl.SFIXED64.ordinal()] = 11;
        } catch (NoSuchFieldError e11) {
        }
        try {
            zzgq[zzfl.SINT32.ordinal()] = 12;
        } catch (NoSuchFieldError e12) {
        }
        try {
            zzgq[zzfl.SINT64.ordinal()] = 13;
        } catch (NoSuchFieldError e13) {
        }
        try {
            zzgq[zzfl.ENUM.ordinal()] = 14;
        } catch (NoSuchFieldError e14) {
        }
        try {
            zzgq[zzfl.BYTES.ordinal()] = 15;
        } catch (NoSuchFieldError e15) {
        }
        try {
            zzgq[zzfl.STRING.ordinal()] = 16;
        } catch (NoSuchFieldError e16) {
        }
        try {
            zzgq[zzfl.GROUP.ordinal()] = 17;
        } catch (NoSuchFieldError e17) {
        }
        try {
            zzgq[zzfl.MESSAGE.ordinal()] = 18;
