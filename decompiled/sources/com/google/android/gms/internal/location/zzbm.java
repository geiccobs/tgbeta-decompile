    ...
    public static int zza(int i, int i2, @NullableDecl String str) {
        ...
        if (i < 0 || i >= i2) {
            if (i < 0) {
                ...
                str2 = zzbn.zza("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i), Integer.valueOf(i2));
            }
    ...
    public static void zzc(int i, int i2, int i3) {
        ...
        if (i < 0 || i2 < i || i2 > i3) {
            if (i < 0 || i > i3) {
                ...
                str = (i2 < 0 || i2 > i3) ? zzd(i2, i3, "end index") : zzbn.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
            }
