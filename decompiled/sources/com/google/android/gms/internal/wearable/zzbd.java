...
final class zzbd extends zzag<Double> implements RandomAccess, zzbz, zzde {
    private static final zzbd zza;
    private double[] zzb;
    private int zzc;

    static {
        zzbd zzbdVar = new zzbd(new double[0], 0);
        zza = zzbdVar;
        zzbdVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        zzad();
        zzca.zza(collection);
        if (!(collection instanceof zzbd)) {
            return super.addAll(collection);
        }
        zzbd zzbdVar = (zzbd) collection;
        int i = zzbdVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzbdVar.zzb, 0, this.zzb, this.zzc, zzbdVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < this.zzc; i2++) {
            i = (i * 31) + zzca.zze(Double.doubleToLongBits(this.zzb[i2]));
        }
        return i;
    }
    ...
    public final /* bridge */ /* synthetic */ zzbz zze(int i) {
        if (i >= this.zzc) {
            return new zzbd(Arrays.copyOf(this.zzb, i), this.zzc);
        }
        throw new IllegalArgumentException();
    }

    private zzbd(double[] dArr, int i) {
        this.zzb = dArr;
        this.zzc = i;
    }
