...
interface zzib {
    ...
    void zza(int i, zzdn zzdnVar) throws IOException;

    <K, V> void zza(int i, zzfq<K, V> zzfqVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzgp zzgpVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzgp zzgpVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzgp zzgpVar) throws IOException;

    void zzb(int i, List<zzdn> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzgp zzgpVar) throws IOException;
