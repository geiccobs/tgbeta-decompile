...
public final class zzip {
    ...
    private static final Logger zzb = Logger.getLogger(zzip.class.getName());
    private static final Class<?> zzd = zzen.zzb();
    ...
    private static final class zza extends zzc {
        ...
        @Override // com.google.android.gms.internal.mlkit_common.zzip.zzc
        public final byte zza(Object obj, long j) {
            if (zzip.zza) {
                return zzip.zzk(obj, j);
            }
            return zzip.zzl(obj, j);
        }
        ...
        public final boolean zzb(Object obj, long j) {
            if (zzip.zza) {
                return zzip.zzm(obj, j);
            }
            return zzip.zzn(obj, j);
        }
    ...
    public static Unsafe zzc() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzio());
        } catch (Throwable th) {
            return null;
        }
    }
    ...
    private static Field zzf() {
        Field zza2;
        if (zzen.zza() && (zza2 = zza(Buffer.class, "effectiveDirectAddress")) != null) {
            return zza2;
        }
