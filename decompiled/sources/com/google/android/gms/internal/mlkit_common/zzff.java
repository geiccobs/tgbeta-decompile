...
final class zzff implements zzjd {
    ...
    public final <K, V> void zza(int i, zzgs<K, V> zzgsVar, Map<K, V> map) throws IOException {
        for (Map.Entry<K, V> entry : map.entrySet()) {
            this.zza.zza(i, 2);
            this.zza.zzb(zzfl.zza(zzgsVar.zza, 1, entry.getKey()) + zzfl.zza(zzgsVar.zzb, 2, entry.getValue()));
            zzfc zzfcVar = this.zza;
            K key = entry.getKey();
            V value = entry.getValue();
            zzfl.zza(zzfcVar, zzgsVar.zza, 1, key);
            zzfl.zza(zzfcVar, zzgsVar.zzb, 2, value);
        }
    }
}
