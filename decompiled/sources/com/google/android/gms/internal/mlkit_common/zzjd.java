...
interface zzjd {
    ...
    void zza(int i, zzep zzepVar) throws IOException;

    <K, V> void zza(int i, zzgs<K, V> zzgsVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhr zzhrVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhr zzhrVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhr zzhrVar) throws IOException;

    void zzb(int i, List<zzep> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhr zzhrVar) throws IOException;
