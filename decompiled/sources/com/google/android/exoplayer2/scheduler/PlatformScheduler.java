...
public final class PlatformScheduler implements Scheduler {
    ...
    public PlatformScheduler(Context context, int jobId) {
        ...
        this.jobId = jobId;
        this.jobServiceComponentName = new ComponentName(context2, PlatformSchedulerService.class);
        this.jobScheduler = (JobScheduler) context2.getSystemService("jobscheduler");
    }
    ...
    public static final class PlatformSchedulerService extends JobService {
        ...
        public boolean onStartJob(JobParameters params) {
            ...
            if (requirements.checkRequirements(this)) {
                ...
                Intent intent = new Intent((String) Assertions.checkNotNull(serviceAction)).setPackage(servicePackage);
