...
public final class AesCipherDataSink implements DataSink {
    ...
    public void write(byte[] data, int offset, int length) throws IOException {
        if (this.scratch == null) {
            ((AesFlushingCipher) Util.castNonNull(this.cipher)).updateInPlace(data, offset, length);
        ...
        while (bytesProcessed < length) {
            ...
            ((AesFlushingCipher) Util.castNonNull(this.cipher)).update(data, offset + bytesProcessed, bytesToProcess, this.scratch, 0);
