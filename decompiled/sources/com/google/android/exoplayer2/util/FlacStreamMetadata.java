...
public final class FlacStreamMetadata {
    ...
    public Format getFormat(byte[] bArr, Metadata metadata) {
        ...
        return Format.createAudioSampleFormat(null, "audio/flac", null, getBitRate(), i, this.channels, this.sampleRate, -1, 0, 0, Collections.singletonList(bArr), null, 0, null, getMetadataCopyWithAppendedEntriesFrom(metadata2));
    }
