...
public final class TrackSelectorResult {
    ...
    public boolean isEquivalent(TrackSelectorResult other, int index) {
        return other != null && Util.areEqual(this.rendererConfigurations[index], other.rendererConfigurations[index]) && Util.areEqual(this.selections.get(index), other.selections.get(index));
    }
}
